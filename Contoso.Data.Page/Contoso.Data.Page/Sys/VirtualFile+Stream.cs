...
namespace Contoso.Sys
{
    public partial class VirtualFile
    {
        ...
        internal RC read32bits(int offset, ref int pRes)
        {
            uint u32_pRes = 0;
        ...
        internal RC read32bits(long offset, ref uint pRes) { return read32bits((int)offset, ref pRes); }
        internal RC read32bits(int offset, ref uint pRes)
        {
            var ac = new byte[4];
        ...
        internal RC write32bits(long offset, uint val)
        {
            var ac = new byte[4];
