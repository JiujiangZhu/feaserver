...
#if TRACE
        internal static bool Trace = true;  // True to enable tracing
        internal static void TRACE(string x, params object[] args) { if (Trace) Console.WriteLine("b:" + string.Format(x, args)); }
#else
