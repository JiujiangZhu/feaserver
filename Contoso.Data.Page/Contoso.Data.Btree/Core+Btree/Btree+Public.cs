...
pBt.secureDelete = true;
        ...
        public RC BeginStmt(int iStatement)
        {
            ...
            var rc = pBt.Pager.OpenSavepoint(iStatement);
            sqlite3BtreeLeave();
            return rc;
        }
...
return rc;
...
#endif
                rc = shared.Pager.CommitPhaseOne(zMaster, false);
                sqlite3BtreeLeave();
            }
            return rc;
        }
        ...
        public RC CommitPhaseTwo(int bCleanup)
        {
            ...
            if (this.InTransaction == TRANS.WRITE)
            {
                ...
                var rc = shared.Pager.CommitPhaseTwo();
        ...
        public RC Rollback()
        {
            ...
            if (this.InTransaction == TRANS.WRITE)
            {
                ...
                if (shared.btreeGetPage(1, ref pPage1, 0) == RC.OK)
                {
                    ...
                    if (nPage == 0)
                        shared.Pager.GetPageCount(out nPage);
                    shared.Pages = nPage;
                    pPage1.releasePage();
                }
