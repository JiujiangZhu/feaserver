...
namespace Contoso.IO
{
    public class MemJournalFile : VirtualFile
    {
        ...
        //public static bool sqlite3IsMemJournal(VirtualFile pJfd) { return pJfd is MemJournalFile; }

        // Return the number of bytes required to store a MemJournal file descriptor.
        public static int sqlite3MemJournalSize() { return 3096; }
    }
}
